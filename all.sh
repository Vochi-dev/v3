...
SERVICES=("admin" "dial" "111" "plan" "smart" "sms" "sms_send" "send_user_sms" "auth" "telegram" "download" "goip" "desk" "call" "miniapp" "asterisk" "retailcrm" "integration_cache" "uon" "ms")
