...
async def main_page(request: Request, enterprise: str = "0367"):
    ...
    call_types = [
        ...
        {"id": 18, "name": "2-7", "description": "Звонок на группу абонентов + мобильный = никто не поднял трубку"},
        {"id": 19, "name": "2-8", "description": "Звонок на отдел = подняли трубку в отделе"},
        {"id": 20, "name": "2-9", "description": "Звонок на отдел = никто не поднял трубку в отделе"},
        {"id": 21, "name": "2-10", "description": "Переадресация вызова с запросом - входящий вызов принял 151, но он не захотел разговаривать\nс этим абонентом, и переадресовал его на другого оператора (152), получив согласие того, разговор состоялся между входящим абонентом и 152-м"},
