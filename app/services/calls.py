...
async def process_start(bot: Bot, chat_id: int, data: dict):
    ...
    logging.debug(f"[process_start] Sending to chat_id={chat_id}: {safe_text!r}")
...
async def process_dial(bot: Bot, chat_id: int, data: dict):
    ...
    safe_text = text.replace("<", "&lt;").replace(">", "&gt;")
    logging.debug(f"[process_dial] Sending to chat_id={chat_id}: {safe_text!r}")
...
async def process_bridge(bot: Bot, chat_id: int, data: dict):
    ...
    safe_text = text.replace("<", "&lt;").replace(">", "&gt;")
    logging.debug(f"[process_bridge] Sending to chat_id={chat_id}: {safe_text!r}")
