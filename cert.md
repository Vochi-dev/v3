...
- **Выдан:** 28 октября 2025
- **Действителен до:** 26 января 2026, 05:40:46 GMT
- **Остается:** ~90 дней
- **Статус:** ✅ АКТИВЕН
...
|------|----------------|------------------|---------|
| 28.10.2025 | 26.01.2026 | Manual Standalone | ✅ Успешно |
| 03.08.2025 | 01.11.2025 | Manual Standalone | ⚠️ Истек |
...
|---------|------|----------|
| **Текущий сертификат истекает** | 26.01.2026 | Автопродление за 30 дней |
| **Критический срок продления** | 27.12.2025 | Ручная проверка |
| **Предупреждение** | 12.01.2026 | Email уведомление |
...
### 28.10.2025 - Плановое продление сертификата
```
⚠️ ПРОБЛЕМА: Сертификат истекал 01.11.2025 (через 4 дня)
🔧 ПРИЧИНА: Подошел срок планового продления
✅ РЕШЕНИЕ: Принудительное продление standalone методом
🎉 РЕЗУЛЬТАТ: Новый сертификат до 26.01.2026 (90 дней)
```

**Выполненные действия:**
1. Проверка текущего сертификата: истекает 01.11.2025
2. Остановка nginx: `systemctl stop nginx`
3. Принудительное продление: `certbot renew --force-renewal --standalone`
4. Запуск nginx: `systemctl start nginx`
5. Проверка нового сертификата: действителен до 26.01.2026
6. Обновление документации cert.md

**Статус:** ✅ Успешно продлен на 90 дней
...
1. **Декабрь 2025:** Резервная проверка перед истечением
2. **Январь 2026:** Плановое продление сертификата
3. **Февраль 2026:** Мониторинг нового продления
